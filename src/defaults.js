...
languages.ko = {
  ...
  error_minimum_incl: 'Value must be at least {{0}}',
  error_multipleOf: 'Value must be a multiple of {{0}}',
  error_not: '모든 값은 스키마를 어기고 검증될 수 없습니다.',
  error_notempty: '값이 없습니다',
  error_notset: '프로퍼티가 주어지지 않았습니다',
  error_oneOf: '값은 검증할 때 스키마의 형식을 어기면 안 됩니다. 현재 {{0}} 스키마를 어긴 값이 있습니다.',
  error_pattern: 'Value must match the pattern {{0}}',
  error_property_names_const_mismatch: 'Property name {{0}} does not match the const value',
  error_property_names_enum: 'Property name {{0}} cannot match invalid enum',
  error_property_names_enum_mismatch: 'Property name {{0}} does not match any enum values',
  ...
  error_time: '시간은 {{0}} 형식이어야 합니다.',
  error_type: '값은 {{0}} 종류여야 합니다.',
  ...
  paste_max_length_reached: '붙여 넣은 텍스트가 길이 {{0}}를 초과하여 일부가 잘립니다.',
  table_controls: '컨트롤',
  upload_max_size: '파일 크기가 너무 큽니다. 최대 허용치는 {{0}}',
  upload_wrong_file_format: '파일 포맷이 잘못되었습니다. 사용 가능한 포맷: {{0}}'
}
